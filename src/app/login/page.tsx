  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-zinc-950 via-zinc-900 to-black flex items-center justify-center px-8">
      ...
      <div className="flex-1 flex justify-center items-center">
        ...
        <form onSubmit={handleLogin} className="w-full max-w-md bg-zinc-900/80 backdrop-blur-sm border border-yellow-500/20 p-10 rounded-2xl shadow-2xl">
          ...
          className="w-full bg-zinc-800 border border-zinc-700 text-white rounded-lg p-4 mb-4 outline-none focus:border-yellow-500 transition"/>
